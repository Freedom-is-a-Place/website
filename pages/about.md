...
Our presence in the city, as privileged members of the Hopkins community, was being leveraged to securitize the border between "us" and "them", "them" being the criminal city of Baltimore. We are told the red lines between privileged Hopkins students and the rest of the city, hard-coded through special Hopkins-only shuttles, securitized by Johns Hopkins private police, and surveilled block by block by city police, are for our “safety”. But I know these vestiges of Jim Crow are nothing more than an attempt to exert institutional, undemocratic control over the city. My response to this tension was to organize with my comrades in the labor movement and community organization, the [Baltimore Abolition Movement](https://baltimoreabolitionmovement.org), for the abolition of the undemocratic and privatized expansion of armed policing, the Johns Hopkins Police Department -- JHU's tool for colonial enforcement. 
