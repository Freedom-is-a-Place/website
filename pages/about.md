...
**“Red”** mapping tracks the spatial patterns of harm and extraction.
- These are the forces that shorten life, create precarity, and make communities vulnerable.
- Red maps visualize the organized abandonment of certain communities and the way racial capitalism sorts risk geographically.

**“Green”** mapping shows the forces that sustain life: care, resources, resistance, and possibility. 
- It’s a method to identify **where people build, nurture, and defend life-giving infrastructures.**
- Reveals the infrastructures of survival—the places where people create freedom, not as an abstract ideal but as material, spatial practice.
